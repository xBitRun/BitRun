...
import type { RiskProfile, TimeHorizon, StrategyPreset } from '@/types';
      ...
      {currentPreset &&
        ...
        (() => {
          const rc = {
            ...
            ...currentPreset.values.riskControls,
          };
          return (
              ...
              <CardContent className="py-3 px-4">
                ...
                <div className="grid grid-cols-3 gap-x-4 gap-y-1.5">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-semibold font-mono">
                      {formatMinutes(
                        currentPreset.values.executionIntervalMinutes
                      )}
                    </p>
                  </div>
                  <div>
                    <p className="text-[10px] text-muted-foreground">
                      {t('summary.timeframes')}
                    </p>
                    <p className="text-xs font-semibold font-mono">
